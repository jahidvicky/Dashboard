    ...
    return (
        <div className="flex items-center justify-center bg-gray-100 mt-10">
            ...
            >
                ...
                {/* Full Name */}
                <div className="mb-4">
                    <label>Full Name<span className="text-[#f00000] ml-1">*</span></label>
                    <input
                        type="text"
                        name="name"
                ...
                {/* Email */}
                <div className="mb-4">
                    <label>Email<span className="text-[#f00000] ml-1">*</span></label>
                    <input
                        type="email"
                        name="email"
                        className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500"
                ...
                <div className="mb-4 relative">
                    <label>Password<span className="text-[#f00000] ml-1">*</span></label>
                    <input

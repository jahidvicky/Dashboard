        ...
        <div className="p-6">
            ...
            <div className="flex gap-3 mb-4">
                {["all", "east", "west"].map((loc) => (
                    <button
                        ...
                        className={`px-3 py-1 rounded capitalize ${locationFilter === loc
                            ? "bg-black text-white"
                            : "border"
                            }`}
                    >
                        ...
                        {currentItems.map((item) => (
                            ...
                            >
                                ...
                                <td className="border p-2 text-center">
                                    ...
                                    {item.inProcessing > 0 && (
                                        <button
                                            onClick={() => moveToFinished(item._id, item.location)}
            ...
            {showAddPopup && (
                <div className="fixed inset-2 backdrop-blur bg-opacity-60 flex items-center justify-center z-50">
                    <div className="bg-white shadow p-6 rounded w-[500px] relative">
                        <button
                        ...
                        <div className="flex items-center gap-2 mb-2">
                            <input
                                ...
                                checked={eastChecked}
                                onChange={(e) =>
                                    setEastChecked(e.target.checked)
                                }
                            />
                            <span>East</span>
                            {eastChecked && (
                        ...
                        <div className="flex items-center gap-2 mb-4">
                            <input
                                ...
                                checked={westChecked}
                                onChange={(e) =>
                                    setWestChecked(e.target.checked)
                                }
                            />
                            <span>West</span>
                            {westChecked && (

        ...
        >
            ...
            >
                ...
                <div className="grid grid-cols-2 gap-4 text-gray-700">
                    ...
                    {order.shipping && <p><strong>Shipping:</strong> ${order.shipping}</p>}
                    {order.tax && <p><strong>Tax:</strong> ${order.tax}</p>}
                    ...
                    >
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            {item.policy && (
                                <>
                                    <p>
                                        <strong>Policy:</strong> {item.policy.name} {item.policy.coverage} | Status: {item.policy.status}
                                    </p>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="grid grid-cols-2 gap-3 text-gray-700">
                                    ...
                                    <p><strong>Description:</strong> {lens.lens.lensType?.description || "N/A"}</p>

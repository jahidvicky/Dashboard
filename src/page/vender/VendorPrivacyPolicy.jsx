        ...
        <div className="min-h-screen bg-gray-200 text-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <header className="mb-8">
                <div className="bg-gradient-to-r from-red-900 via-black to-black rounded-2xl p-6 shadow-2xl border-2 border-red-700 py-12">
                    <h1 className="text-3xl sm:text-4xl font-extrabold text-[#f00000] text-center">
                        Privacy Policy
                    </h1>
                </div>
            </header>
            <section className="space-y-6 text-gray-200">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">2. How We Use Your Information</h2>
                <ul className="list-disc pl-6 space-y-2 text-black">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">3. Data Sharing and Disclosure</h2>
                <p className="text-black">
                    We do <span className="text-[#f00000] font-semibold">not sell</span> vendor data. Information may be shared only with:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-black">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">4. Data Security</h2>
                <p className="text-black">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">5. Your Rights</h2>
                <ul className="list-disc pl-6 space-y-2 text-black">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">6. Policy Updates</h2>
                <p className="text-black">
                ...
                <h2 className="text-2xl font-semibold text-[#f00000] mt-8">7. Contact Us</h2>
                <p className="text-black">
                    For any questions or concerns regarding this policy, please contact us at:
                </p>
                <p className="text-black">
                    Email: <span className="text-[#f00000]">{vendorData.contactEmail}</span><br />
                    Phone: <span className="text-[#f00000]">{vendorData.contactPhone}</span><br />
                    Address: <span className="text-[#f00000]">{vendorData.address1}{vendorData.address2}</span>
                </p>
            </section>
